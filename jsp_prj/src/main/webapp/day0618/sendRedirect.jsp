...
<link href="http://192.168.10.68/jsp_prj/common/js/bootstrap.min.css" rel="stylesheet"
	integrity="sha384-sRIl4kxILFvY47J16cr9ZwB07vP4J8+LH7qKQnuqkuIAvNWLzeN8tE5YBujZqJLB">

<meta name="theme-color" content="#712cf9">
<link href="http://192.168.10.68/jsp_prj/common/js/carousel.css" rel="stylesheet">
<style>
.bd-placeholder-img {
	font-size: 1.125rem;
	text-anchor: middle;
...
<%
log("asdfjkhfsdjhkfsdakjhasdfjhkasdfjhkasdfjhkasdfhjkasdfhjkasdfkjh");
%>